...
#include "mav_system_msgs/msg/detail/process_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mav_system_msgs::msg::ProcessInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mav_system_msgs::msg::ProcessInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mav_system_msgs::msg::ProcessInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ProcessInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mav_system_msgs::msg::ProcessInfo *>(
...
static size_t _ProcessInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ProcessInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ProcessInfo__callbacks = {
  "mav_system_msgs::msg",
  "ProcessInfo",
...
static rosidl_message_type_support_t _ProcessInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ProcessInfo__callbacks,
...
{
  return &mav_system_msgs::msg::typesupport_fastrtps_cpp::_ProcessInfo__handle;
}
