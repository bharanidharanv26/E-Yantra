...
#include "whycode_interfaces/msg/detail/marker_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const whycode_interfaces::msg::Marker &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  whycode_interfaces::msg::Marker &);
size_t get_serialized_size(
  const whycode_interfaces::msg::Marker &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const whycode_interfaces::msg::MarkerArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: markers
  {
    ...
    for (size_t i = 0; i < size; i++) {
      whycode_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  whycode_interfaces::msg::MarkerArray & ros_message)
{
  // Member: header
  ...
  // Member: markers
  {
    ...
    for (size_t i = 0; i < size; i++) {
      whycode_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        whycode_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        whycode_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Marker(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = whycode_interfaces::msg::MarkerArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const whycode_interfaces::msg::MarkerArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<whycode_interfaces::msg::MarkerArray *>(
    untyped_ros_message);
...
{
  return &whycode_interfaces::msg::typesupport_fastrtps_cpp::_MarkerArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, whycode_interfaces, msg, MarkerArray)() {
  return &whycode_interfaces::msg::typesupport_fastrtps_cpp::_MarkerArray__handle;
}
