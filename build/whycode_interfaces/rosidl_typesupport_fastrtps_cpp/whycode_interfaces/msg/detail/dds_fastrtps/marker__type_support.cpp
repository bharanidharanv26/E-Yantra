...
#include "whycode_interfaces/msg/detail/marker__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const whycode_interfaces::msg::Marker & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  whycode_interfaces::msg::Marker & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = whycode_interfaces::msg::Marker;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const whycode_interfaces::msg::Marker *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<whycode_interfaces::msg::Marker *>(
    untyped_ros_message);
...
{
  return &whycode_interfaces::msg::typesupport_fastrtps_cpp::_Marker__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, whycode_interfaces, msg, Marker)() {
  return &whycode_interfaces::msg::typesupport_fastrtps_cpp::_Marker__handle;
}
