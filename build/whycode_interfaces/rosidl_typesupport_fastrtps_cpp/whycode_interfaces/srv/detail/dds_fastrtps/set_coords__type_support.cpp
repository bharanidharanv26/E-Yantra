...
#include "whycode_interfaces/srv/detail/set_coords__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const whycode_interfaces::srv::SetCoords_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  whycode_interfaces::srv::SetCoords_Request & ros_message)
{
  // Member: coords
  cdr >> ros_message.coords;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = whycode_interfaces::srv::SetCoords_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const whycode_interfaces::srv::SetCoords_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<whycode_interfaces::srv::SetCoords_Request *>(
    untyped_ros_message);
...
{
  return &whycode_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, whycode_interfaces, srv, SetCoords_Request)() {
  return &whycode_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_whycode_interfaces
cdr_serialize(
  const whycode_interfaces::srv::SetCoords_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  whycode_interfaces::srv::SetCoords_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = whycode_interfaces::srv::SetCoords_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const whycode_interfaces::srv::SetCoords_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<whycode_interfaces::srv::SetCoords_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &whycode_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, whycode_interfaces, srv, SetCoords_Response)() {
  return &whycode_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords_Response__handle;
}
...
{
  return &whycode_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, whycode_interfaces, srv, SetCoords)() {
  return &whycode_interfaces::srv::typesupport_fastrtps_cpp::_SetCoords__handle;
}
