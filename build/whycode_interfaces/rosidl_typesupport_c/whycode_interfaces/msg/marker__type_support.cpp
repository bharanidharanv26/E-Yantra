...
static const _Marker_type_support_symbol_names_t _Marker_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, whycode_interfaces, msg, Marker)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, whycode_interfaces, msg, Marker)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, whycode_interfaces, msg, Marker)() {
  return &::whycode_interfaces::msg::rosidl_typesupport_c::Marker_message_type_support_handle;
}
