...
static const _SetCoords_Request_type_support_symbol_names_t _SetCoords_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, whycode_interfaces, srv, SetCoords_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, whycode_interfaces, srv, SetCoords_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, whycode_interfaces, srv, SetCoords_Request)() {
  return &::whycode_interfaces::srv::rosidl_typesupport_c::SetCoords_Request_message_type_support_handle;
}
...
static const _SetCoords_Response_type_support_symbol_names_t _SetCoords_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, whycode_interfaces, srv, SetCoords_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, whycode_interfaces, srv, SetCoords_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, whycode_interfaces, srv, SetCoords_Response)() {
  return &::whycode_interfaces::srv::rosidl_typesupport_c::SetCoords_Response_message_type_support_handle;
}
...
static const _SetCoords_type_support_symbol_names_t _SetCoords_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, whycode_interfaces, srv, SetCoords)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, whycode_interfaces, srv, SetCoords)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, whycode_interfaces, srv, SetCoords)() {
  return &::whycode_interfaces::srv::rosidl_typesupport_c::SetCoords_service_type_support_handle;
}
