...
#ifndef WHYCODE_INTERFACES__SRV__DETAIL__SET_CALIB_PATH__FUNCTIONS_H_
#define WHYCODE_INTERFACES__SRV__DETAIL__SET_CALIB_PATH__FUNCTIONS_H_
...
/// Initialize srv/SetCalibPath message.
/**
...
/// Finalize srv/SetCalibPath message.
/**
...
/// Create srv/SetCalibPath message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * whycode_interfaces__srv__SetCalibPath_Request__init().
...
/// Destroy srv/SetCalibPath message.
/**
 * It calls
 * whycode_interfaces__srv__SetCalibPath_Request__fini()
...
/// Check for srv/SetCalibPath message equality.
/**
...
/// Copy a srv/SetCalibPath message.
/**
...
/// Initialize array of srv/SetCalibPath messages.
/**
...
/// Finalize array of srv/SetCalibPath messages.
/**
 * It calls
 * whycode_interfaces__srv__SetCalibPath_Request__fini()
...
/// Create array of srv/SetCalibPath messages.
/**
 * It allocates the memory for the array and calls
 * whycode_interfaces__srv__SetCalibPath_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetCalibPath messages.
/**
 * It calls
 * whycode_interfaces__srv__SetCalibPath_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetCalibPath message array equality.
/**
...
/// Copy an array of srv/SetCalibPath messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * whycode_interfaces__srv__SetCalibPath_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_whycode_interfaces
...
/**
 * It calls
 * whycode_interfaces__srv__SetCalibPath_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_whycode_interfaces
...
/**
 * It allocates the memory for the array and calls
 * whycode_interfaces__srv__SetCalibPath_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_whycode_interfaces
...
/**
 * It calls
 * whycode_interfaces__srv__SetCalibPath_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // WHYCODE_INTERFACES__SRV__DETAIL__SET_CALIB_PATH__FUNCTIONS_H_
